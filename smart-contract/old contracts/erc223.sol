...
contract WiiggoCoin is ERC223Token {
  using SafeMath for uint256;

  // for example, "Bitcoin"
  string public name = "WiiggoCoin";
  // for example, "BTC"
  string public symbol = "WIIG";
  ...
  uint public totalSupply = 9000000000 * (10**decimals);
